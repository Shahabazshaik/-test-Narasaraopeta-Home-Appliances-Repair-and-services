...
function interpreterImpl(expr, code$1, id$1, moduleType$1, ctx = {}) {
  ...
  for (const e of expr)
    switch (e.kind) {
      case "include": {
        hasInclude = true;
        if (exprInterpreter(e.expr, code$1, id$1, moduleType$1, ctx))
          return true;
        break;
      }
      case "exclude": {
  ...
  switch (expr.kind) {
    case "and":
      return expr.args.every((e) =>
        exprInterpreter(e, code$1, id$1, moduleType$1, ctx),
      );
    case "or":
    ...
    case "not":
      return !exprInterpreter(expr.expr, code$1, id$1, moduleType$1, ctx);
    case "id": {
      if (id$1 === void 0)
      ...
      return typeof expr.pattern === "string"
        ? id$1 === expr.pattern
        : expr.pattern.test(id$1);
    }
    case "moduleType": {
      if (moduleType$1 === void 0)
    ...
    case "code": {
      ...
      return typeof expr.pattern === "string"
        ? code$1.includes(expr.pattern)
        : expr.pattern.test(code$1);
    }
    case "query": {
      if (id$1 === void 0)
