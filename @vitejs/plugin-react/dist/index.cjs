  ...
  rollupOptions: {
    onwarn(warning, defaultHandler) {
      ...
      if (
        ...
        return;
      if (
        (_userConfig$build = userConfig.build) === null ||
        _userConfig$build === void 0 ||
        (_userConfig$build = _userConfig$build.rollupOptions) === null ||
        _userConfig$build === void 0
          ? void 0
          : _userConfig$build.onwarn
      )
...
//#endregion
//#region src/index.ts
const _dirname = (0, node_path.dirname)(
...
function viteReact(opts = {}) {
  ...
  const viteBabel = {
    ...
    configResolved(config) {
      ...
      const hooks = config.plugins
        .map((plugin) => {
          var _plugin$api;
          return (_plugin$api = plugin.api) === null || _plugin$api === void 0
            ? void 0
            : _plugin$api.reactBabel;
        })
        .filter(defined);
      if (
        "rolldownVersion" in vite &&
    ...
    transform: {
      filter: {
        id: {
          include: (0, __rolldown_pluginutils.makeIdFiltersToMatchWithQuery)(
            include,
          ),
          exclude: [
            ...(exclude
              ? (0, __rolldown_pluginutils.makeIdFiltersToMatchWithQuery)(
                  ensureArray(exclude),
                )
              : []),
            /\/node_modules\//,
  ...
  const staticBabelPlugins =
    typeof opts.babel === "object"
      ? (((_opts$babel = opts.babel) === null || _opts$babel === void 0
          ? void 0
          : _opts$babel.plugins) ?? [])
      : [];
    ...
    load: {
      ...
      handler(id) {
        if (id === runtimePublicPath)
          return (0, node_fs.readFileSync)(refreshRuntimePath, "utf-8").replace(
            /__README_URL__/g,
...
function createBabelOptions(rawOptions) {
  ...
  (_babelOptions$parserO = babelOptions.parserOpts).plugins ||
    (_babelOptions$parserO.plugins = []);
  return babelOptions;
}
...
function getReactCompilerRuntimeModule(plugin) {
  ...
  if (Array.isArray(plugin)) {
    ...
    if (
      ((_plugin$ = plugin[1]) === null || _plugin$ === void 0
        ? void 0
        : _plugin$.target) === "17" ||
      ((_plugin$2 = plugin[1]) === null || _plugin$2 === void 0
        ? void 0
        : _plugin$2.target) === "18"
    )
      moduleName = "react-compiler-runtime";
    else if (
      typeof ((_plugin$3 = plugin[1]) === null || _plugin$3 === void 0
        ? void 0
        : _plugin$3.runtimeModule) === "string"
    ) {
      var _plugin$4;
      moduleName =
        (_plugin$4 = plugin[1]) === null || _plugin$4 === void 0
          ? void 0
          : _plugin$4.runtimeModule;
    }
  }
  return moduleName;
}
