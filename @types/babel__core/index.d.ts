...
export interface TransformOptions {
   ...
   */
  env?:
    { [index: string]: TransformOptions | null | undefined } | null | undefined;
   ...
   */
  getModuleId?:
    ((moduleName: string) => string | null | undefined) | null | undefined;
   ...
   */
  shouldPrintComment?:
    ((commentContents: string) => boolean) | null | undefined;
